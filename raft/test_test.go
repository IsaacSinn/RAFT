...
func TestFailAgree4B(t *testing.T) {
	...
	fmt.Printf("Disconnected peer: %v\n", (leader+1)%servers)
...
func TestBackup4B(t *testing.T) {
	...
	for i := 0; i < servers; i++ {
		cfg.connect(i)
		fmt.Printf("Connecting everyone back %v\n", i)
